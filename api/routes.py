...
from api.forms import RegistrationForm, LoginForm, PostForm
from api.models import User, Posts
from flask_login import login_required, login_user, logout_user, current_user
import datetime

albums: list[Posts] = [
    Posts('Zhaba Zhiza', '2024', 'Highway to Hell', '1978'),
    Posts('Ihor Dzhus', '2022', 'Iron Man 2222', '2010'),
    Posts('Karina Zbun', '2023', 'Black in Black in Black in Black in Black', '1980'),
]
